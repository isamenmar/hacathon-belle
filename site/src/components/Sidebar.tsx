...
const nav = [
  ...
  { href: "/empreendimentos/caraga-spot", label: "Caraguá", icon: "🏗️" },
];

export default function Sidebar() {
  const pathname = usePathname();
  return (
    <aside className="hidden lg:flex lg:flex-col w-64 bg-gray-900 border-r border-gray-800 overflow-y-auto">
      <div className="p-5 border-b border-gray-800">
        <h1 className="text-xl font-bold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
          Belle Analytics
        </h1>
        <p className="text-xs text-gray-500 mt-1">Seazone Investimentos</p>
      </div>
